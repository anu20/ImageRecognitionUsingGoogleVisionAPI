...
class Article(models.Model):
    ...
    def create_ingredients(self,ingredients):
        ...
        for ingredient in ingredient_list:
            if ingredient:
                t, created = Ingredient.objects.get_or_create(ingredient=ingredient.lower(),
                                                       article=self)
    ...
    def get_ingredients(self):
        return Ingredient.objects.filter(article=self)
...
class Ingredient(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _('Ingrdients')
        unique_together = (('ingredient', 'article'),)
        index_together = [['ingredient', 'article'], ]
