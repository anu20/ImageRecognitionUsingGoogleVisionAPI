...
from Project.core.forms import ProfileForm, ChangePasswordForm
from Project.articles.models import Article
from Project.feeds.views import FEEDS_NUM_PAGES
from Project.articles.views import articles
...
def profile(request, username):
    ...
    all_articles = Article.get_published().filter(create_user=page_user)
    paginator = Paginator(all_articles, FEEDS_NUM_PAGES)
    articles = paginator.page(1)
    from_article = -1
    if articles:
        from_article = articles[0].id
